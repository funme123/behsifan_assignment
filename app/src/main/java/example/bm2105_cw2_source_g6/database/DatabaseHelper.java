...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long insertUser(String username, String contact_num, String password,String Address) {
    ...
    public User getUser(String username) {
        ...
        Cursor cursor = db.query(User.TABLE_NAME,
                new String[]{User.COLUMN_ID, User.COLUMN_NAME,
                        User.COLUMN_CONTACT_NUM, User.COLUMN_PASSWORD, User.COLUMN_ADDRESS},
                User.COLUMN_NAME + "=?",
        ...
        try {
            ...
            user = new User(
                    ...
                    cursor.getString(cursor.getColumnIndex(User.COLUMN_ADDRESS)));
        } catch (Exception e){
            user = new User();
        }
